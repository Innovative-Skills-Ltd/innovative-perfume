            ...
            <div>
                <table class="border rounded-md w-full">
                    <tr class="border-b">
                        <td class="p-7">
                            <img class="w-24 h-24"
                                src="https://dreamingtheme.kiendaotac.com/html/stelina/assets/images/cart-item-2.jpg" />
                            <a href="#" class="block"> Mini swing dress </a>
                        ...
                        <td class="p-7 ps-0">
                            <span class="text-xl font-medium">$45</span>
                        </td>
                        <td class="py-7">
                ...
                <div class="mt-7 flex items-center justify-end gap-5">
                    <a href="shop.html">
                        <button class="px-5 font-semibold py-2 border rounded-full text-sm uppercase">
                            CONTINUE SHOPPING
                        </button>
                    </a>
