                ...
                <div x-data="{
                    ...
                    <div x-show="step === 'shipping'" class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl ">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-20">
                                <div class="md:col-span-2">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                                        ...
                                        {{-- Address --}}
                                        <div>
                                            <label class="text-sm mb-1">Address <span
                                        ...
                                        {{-- Zip Code --}}
                                        <div>
                                            <label class="text-sm mb-1">Zip Code <span
                                                    class="text-red-500">*</span></label>
                                            <input name="post_code" type="number"
                                                value='{{ old('post_code', $post_code) }}'
                                                class="py-2 px-5 rounded-full w-full border" />
                                    ...
                                    <!-- NEW ROW FOR DELIVERY CHARGE RADIO BUTTONS -->
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                                        <div>
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <!-- Outside Dhaka -->
                                                <input type="radio" id="outsideDhaka" name="delivery_charge"
                                        ...
                                        <div>
                                            ...
                                            @foreach ($carts as $cart)
                                                ...
                                                <div class="flex items-center gap-7 pb-7 border-b mb-7">
                                                    <img class="w-24 h-24"
                                                        src="{{ $cart?->product?->thumbnail_url }}" />
                                                    <div>
                                                        <h4 class="py-1 font-medium">{{ $cart?->product?->title }}
                                                        </h4>
                                            ...
                                            <div class="border rounded-lg pl-6 py-4 pr-4" x-init="@if (old('payment_type') == 'bank_transfer') payment.type = 'bank_transfer' @else payment.type = 'mobile_banking' @endif">
                                                <label class="flex items-center gap-4 mb-6 cursor-pointer">
                                                    ...
                                                    <div class="flex gap-4">
                                                        <img src="{{ asset('images/default/bkash-nagad.jpg') }}"
                                                            alt="bKash" class="h-12">
                                                    </div>
                                                </label>

                                                <div x-show="payment.type === 'mobile_banking'" x-show=""
                                                    class="space-y-4">
                                                    <p class="font-medium">Pay via Send Money</p>
                                                    <p>bKash/Nagad/Rocket: 01705644008</p>
                                                    <div>
                                                        <p class="font-medium mb-2">Payment Amount: ৳
                                                            {{ $total_amount }}</p>
                                                        <div>
                                                            <label class="text-sm mb-1 block">Enter Transaction ID
                                                                <span class="text-red-500">*</span></label>
                                                            <input type="text" name="mobile_transaction_id"
                                                                value="{{ old('mobile_transaction_id') }}"
                                                                class="py-2 px-5 rounded-md w-full border"
                                                                placeholder="Enter your transaction ID">
                                                            @isset($errorsn['mobile_transaction_id'])
                                                                <p class="text-red-500"
                                                                    x-show="payment.type === 'mobile_banking'">
                                                                    {{ $errorsn['mobile_transaction_id'] }}</p>
                                                            @endisset
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="border rounded-lg pl-6 py-4 pr-4">
                                                <label class="flex items-center gap-4 mb-6 cursor-pointer">
                                                    <input type="radio" name="payment_type" value="bank_transfer"
                                                        x-model="payment.type" class="w-4 h-4">
                                                    <img src="{{ asset('images/default/dutch-bangla.png') }}"
                                                        alt="Dutch-Bangla Bank" class="h-12">
                                                </label>

                                                <div x-show="payment.type === 'bank_transfer'" class="space-y-4">
                                                    <div class="space-y-2">
                                                        <p><span class="font-medium">Account Number:</span>
                                                            292.158.0002557</p>
                                                        <p><span class="font-medium">Account Name:</span> Salman Md
                                                            Sultan</p>
                                                        <p><span class="font-medium">Bank Name:</span> Dutch Bangla
                                                            bank limited</p>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div>
                                                            ...
                                                            @isset($errorsn['bank_transaction_id'])
                                                                <p class="text-red-500"
                                                                    x-show="payment.type === 'bank_transfer'">
                                                                    {{ $errorsn['bank_transaction_id'] }}</p>
                                                            @endisset
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div x-show="step === 'confirmation'" class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl ">
                            <div
                                class="border rounded px-5 md:ps-7 py-10 mb-6 flex flex-col items-center justify-center">
