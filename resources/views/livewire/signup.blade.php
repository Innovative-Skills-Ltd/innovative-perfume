   ...
   <section class="container mx-auto px-2 md:px-0 pb-20">
       ...
       <div class="grid grid-cols-1 md:grid-cols-2 gap-7">
               ...
               <div class="px-10 py-6 border border-t-0 rounded-b-lg">
                   ...
                   <div>
                       ...
                       <div class="mb-5">
                           ...
                           <input class="py-2 px-5 border w-full rounded-full" type="password" />
                       </div>
           ...
           <form wire:submit.prevent="register">
               ...
               <div class="px-10 py-6 border border-t-0 rounded-b-lg">
                   <p class="text-secondary mb-5">Register with your details</p>
                   <div>
                       <div class="mb-5">
                           <label class="text-sm mb-1">Your email</label>
                           <input wire:model="email" class="py-2 px-5 border w-full rounded-full" type="email" />
                           @error('email')
                       ...
                       <div class="mb-5">
                           <div class="flex items-center gap-1">
                               ...
                               <p class="text-sm text-secondary">
                                   I agree to
                                   <a href="{{ route('tc') }}" class="text-black">Terms & Conditions</a>
                               </p>
                           </div>
                           @error('terms')
                               <span class="text-red-500 text-sm">{{ $message }}</span>
